...
项目对应文件路径：`shopkeeper-agent-backend/app/agent/llm.py`
...
项目对应文件路径：`shopkeeper-agent-backend/app/prompt/prompt_loader.py`
...
项目对应文件路径：`shopkeeper-agent-backend/app/agent/nodes/recall_column.py`
...
```text
shopkeeper-agent-backend/prompts/extend_keywords_for_metric_recall.prompt
```
...
项目对应文件路径：`shopkeeper-agent-backend/app/agent/nodes/recall_metric.py`
...
指标实体对应文件：`shopkeeper-agent-backend/app/entities/metric_info.py`
...
```text
shopkeeper-agent-backend/prompts/extend_keywords_for_value_recall.prompt
```
...
项目对应文件路径：`shopkeeper-agent-backend/app/agent/nodes/recall_value.py`
...
字段取值实体对应文件：`shopkeeper-agent-backend/app/entities/value_info.py`
...
```text
(shopkeeper-agent-backend) tools@ToolsMacBook-Pro shopkeeper-agent-backend % uv run python -m app.agent.graph
