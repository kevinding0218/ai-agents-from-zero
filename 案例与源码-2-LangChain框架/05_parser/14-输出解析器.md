...
【案例源码】`StrOutputParserDemo.py`

[StrOutputParserDemo.py](StrOutputParserDemo.py)
...
【案例源码】`JsonOutputParserDemo.py`

[JsonOutputParserDemo.py](JsonOutputParserDemo.py)
...
【案例源码】`JsonOutputParser_GetFormatInstructions.py`

[JsonOutputParser_GetFormatInstructions.py](JsonOutputParser_GetFormatInstructions.py)
...
【案例源码】`StructuredOutput_TypedDict.py`

[StructuredOutput_TypedDict.py](StructuredOutput_TypedDict.py)
...
【案例源码】`AnnotatedTypedDict.py`

[AnnotatedTypedDict.py](AnnotatedTypedDict.py)
...
【案例源码】`AnnotatedPydantic.py`

[AnnotatedPydantic.py](AnnotatedPydantic.py)
...
【案例源码】`StructuredOutput_Pydantic.py`

[StructuredOutput_Pydantic.py](StructuredOutput_Pydantic.py)
