...
![](../../images/3.4/3.4-1-1-1.png)

#### 1.1.1 深度求索 API

![](../../images/3.4/3.4-1-1-2.png)

![](../../images/3.4/3.4-1-1-3.png)

#### 1.1.2 兼容 OpenAI API 的供应商

如果待配置的模型供应商没有出现在官方提供的列表中，可以选择兼容 OpenAI API 的供应商，几乎所有供应商都兼容 OpenAI API 规范。

![](../../images/3.4/3.4-1-1-4.png)

**以腾讯云为例**

![](../../images/3.4/3.4-1-1-5.png)

![](../../images/3.4/3.4-1-1-6.png)

**模型名称**需要在腾讯云官方提供的 API 文档查询。

![](../../images/3.4/3.4-1-1-7.png)
...
![](../../images/3.4/3.4-1-2-1.png)

这些插件需要在工具中搜索并安装：

![](../../images/3.4/3.4-1-2-2.png)

需要注意的是，电子邮件需要在精选中查找：

![](../../images/3.4/3.4-1-2-3.png)

#### 1.2.2 google 搜索授权

**注意：搜索工具需要授权，按照提示跳转至官网申请 API Key 即可。**

![](../../images/3.4/3.4-1-2-4.png)

![](../../images/3.4/3.4-1-2-5.png)

![](../../images/3.4/3.4-1-2-6.png)

![](../../images/3.4/3.4-1-2-7.png)

粘回来：

![](../../images/3.4/3.4-1-2-8.png)

#### 1.2.3 Firecrawl 授权

授权过程：

![](../../images/3.4/3.4-1-2-9.png)

![](../../images/3.4/3.4-1-2-10.png)

![](../../images/3.4/3.4-1-2-11.png)

![](../../images/3.4/3.4-1-2-12.png)

#### 1.2.4 电子邮件授权

需要授权，方式如下：

![](../../images/3.4/3.4-2-10-1.png)
...
![](../../images/3.4/3.4-1-2-14.png)

![](../../images/3.4/3.4-1-2-15.png)

![](../../images/3.4/3.4-1-2-16.png)

### 1.3 创建工作流

![](../../images/3.4/3.4-1-3-1.png)

![](../../images/3.4/3.4-1-3-2.png)
...
![](../../images/3.4/3.4-2-2-2.png)

#### 2.2.2 配置输入

通过 `/` 或 `{` 唤起变量菜单，如下：

![](../../images/3.4/3.4-2-2-3.png)

此处将 target 变量作为搜索工具节点的输入。

![](../../images/3.4/3.4-2-2-4.png)

#### 2.2.3 配置输出

输出数据格式固定，如下：

![](../../images/3.4/3.4-2-2-5.png)

#### 2.2.4 测试

![](../../images/3.4/3.4-2-2-6.png)

输入：

搜索框写入 `中美两国AI发展现状`。

![](../../images/3.4/3.4-2-2-7.png)

输出：

![](../../images/3.4/3.4-2-2-8.png)
...
![](../../images/3.4/3.4-2-4-1.png)

#### 2.4.2 选择输入

![](../../images/3.4/3.4-2-4-2.png)
...
![](../../images/3.4/3.4-2-4-3.png)

![](../../images/3.4/3.4-2-4-4.png)

###### ③ 编写代码

![](../../images/3.4/3.4-2-4-5.png)
...
![](../../images/3.4/3.4-2-4-6.png)

**2. 测试结果如下**

![](../../images/3.4/3.4-2-4-7.png)
...
![](../../images/3.4/3.4-2-4-8.png)

###### ② 配置

![](../../images/3.4/3.4-2-4-9.png)
...
![](../../images/3.4/3.4-2-4-10.png)

###### ④ 测试

1. 输入

![](../../images/3.4/3.4-2-4-11.png)
...
![](../../images/3.4/3.4-2-4-13.png)

###### ② 选择模型

![](../../images/3.4/3.4-2-4-14.png)
...
![](../../images/3.4/3.4-2-5-1.png)

#### 2.5.2 配置输入

![](../../images/3.4/3.4-2-5-2.png)

#### 2.5.3 编写代码

![](../../images/3.4/3.4-2-5-3.png)
...
![](../../images/3.4/3.4-2-5-5.png)

##### 2. 输出

![](../../images/3.4/3.4-2-5-6.png)
...
![](../../images/3.4/3.4-2-6-2.png)

##### 2. 输出

API 请求超时，切换为内置模型测试。

![](../../images/3.4/3.4-2-6-3.png)
...
![](../../images/3.4/3.4-2-7-1.png)

#### 2.7.2 配置模型及输入变量

![](../../images/3.4/3.4-2-7-2.png)

> 这里也可以改为硅基流动的 DeepSeek-V3 模型试试。

#### 2.7.3 配置提取参数

![](../../images/3.4/3.4-2-7-3.png)

![](../../images/3.4/3.4-2-7-4.png)

#### 2.7.4 配置提示词

![](../../images/3.4/3.4-2-7-5.png)
...
![](../../images/3.4/3.4-2-7-6.png)

#### 2.7.6 测试

将 LLM2 节点输出的 text 字段作为输入

![](../../images/3.4/3.4-2-7-7.png)
...
![](../../images/3.4/3.4-2-8-2.png)

###### 2. 配置

![](../../images/3.4/3.4-2-8-3.png)
...
#### 2.9.1 创建
 ...
 ![](../../images/3.4/3.4-2-9-1.png)

#### 2.9.2 配置输入

 ![](../../images/3.4/3.4-2-9-2.png)
...
![](../../images/3.4/3.4-2-10-2.png)

#### 2.10.3 配置

![](../../images/3.4/3.4-2-10-3.png)

![](../../images/3.4/3.4-2-10-4.png)

#### 2.9.4 测试

![](../../images/3.4/3.4-2-10-5.png)
...
![](../../images/3.4/3.4-2-10-6.png)

**查看目标邮箱**

![](../../images/3.4/3.4-2-10-7.png)
...
![](../../images/3.4/3.4-2-10-8.png)

#### 2.10.2 配置

![](../../images/3.4/3.4-2-10-9.png)

### 2.11 试运行

#### 2.11.1 试运行

![](../../images/3.4/3.4-2-11-1.png)

#### 2.11.2 输入需求

![](../../images/3.4/3.4-2-11-2.png)
...
![](../../images/3.4/3.4-2-11-3.png)

可以追踪每个节点的运行情况

点开迭代节点可以查看每个子节点的运行情况

![](../../images/3.4/3.4-2-11-4.png)

![](../../images/3.4/3.4-2-11-5.png)

#### 2.11.4 查看运行历史

![](../../images/3.4/3.4-2-11-6.png)
...
![](../../images/3.4/3.4-2-11-7.png)

##### 2. 详情

![](../../images/3.4/3.4-2-11-8.png)
