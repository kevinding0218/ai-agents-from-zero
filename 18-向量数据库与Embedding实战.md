...
![传统数据库与向量数据库的查询方式对比：字段精确查询侧重值匹配，向量检索侧重语义相似](images/18/18-2-2-1.png)
...
![稠密向量与稀疏向量对比：稠密向量表达整体语义，稀疏向量更接近关键词权重](images/18/18-2-4-1.png)
...
![向量与向量库在知识体系中的位置](images/18/18-2-6-1.jpeg)
...
![HNSW 索引示意：通过分层近邻图减少全量比较，在召回率与查询速度之间折中](images/18/18-5-3-1.png)
