...
- https://docs.langchain.com/oss/python/langchain/models#structured-output （英文）
- https://docs.langchain.org.cn/oss/python/langchain/models#structured-output （中文）
...
- 学本章最重要的不是背 API，而是建立工程认知：**大模型输出往往还要继续进入程序链路，因此必须结构化**。
